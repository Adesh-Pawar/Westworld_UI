...
class WestworldPage extends StatefulWidget {
  @override
  _WestworldPageState createState() => _WestworldPageState();
}

class _WestworldPageState extends State<WestworldPage> {
  var data;
  @override
  void initState() {
    super.initState();
